...
public class Submarine : MonoBehaviour {
    ...
    void Update () {
        ...
        transform.localEulerAngles += (Vector3.up * yawVelocity + Vector3.forward * pitchVelocity) * Time.deltaTime * speedPercent;
        ...
        rudderPitch.localEulerAngles = Vector3.forward * pitchVelocity / maxPitchSpeed * rudderAngle;
